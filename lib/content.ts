...
export const DEFAULT_CONTENT: ContentData = {
  ...
  selectedMoments: [
  ['순발력 미니 게임', '반응속도 콘 터치 게임과 팀 단합이 시작되는 장면'],
  ['서킷 인터벌', '보랏빛 조명 아래 이어지는 6스테이션 전신 서킷'],
  ['릴레이 달리기', '응원과 기록이 동시에 터지는 팀 이어달리기'],
  ['리커버리', '치킨 샌드위치, 과일컵, 전해질 드링크로 마무리'],
] as Tuple2[],
  manifestoHeading: {
  ...
  ['메인 서킷', '18:45 - 18:52 (7분)', '메인 서킷 2라운드', '5개 종목 순환 (종목당 1분 운동 + 30초 휴식/이동)'],
