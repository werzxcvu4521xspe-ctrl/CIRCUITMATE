export type SiteSectionId = 'home' | 'brand' | 'program' | 'recovery' | 'pricing' | 'awards' | 'booking' | 'location';
...
export const DEFAULT_SITE_MAP: SiteSection[] = [
  ...
  {
    id: 'location',
    label: '08. Location & FAQ',
    href: '#location',
    title: '공간 아이덴티티, 오시는 길, 자주 묻는 질문',
    description: '실내테니스팡의 보랏빛 코트 무드와 시설 안내, 네이버 지도 연동을 고려한 길찾기 구성을 담았습니다.',
    visible: true,
    order: 8,
  },
];
