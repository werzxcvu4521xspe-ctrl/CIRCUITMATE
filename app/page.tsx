...
const brandManifesto = [
  ...
  '스트레스를 완벽하게 날려버리고 내 안의 자신감과 활력을 되찾는 것, 그것이 우리가 주고자 하는 핵심 경험이자 결과입니다.',
  '활력이야말로 모든 자신감과 에너지의 원천입니다. 우리는 누구나 칙칙한 무기력함에서 벗어나 가장 활력 있는 삶을 살았으면 좋겠습니다.',
  '오늘, 이곳에서 서로의 에너지를 나누며 당신의 삶에 가장 강렬한 활력을 채워가세요. 당신과 함께 에너지 넘치는 삶을 살 수 있어서 기쁩니다.',
];
...
const faqs: FaqItem[] = [
  ...
  {
    question: '취소 및 환불 정책',
    answer: ['매치 시작 시점 대비 취소 환불 규정은 아래 기준으로 적용됩니다.'],
    table: {
      head: ['시점', '환불'],
      rows: [
        ['매치 2일 전', '무료 취소'],
        ['매치 1일 전', '80% 환불'],
        ['당일부터 매치 시작 90분 전까지', '20% 환불'],
        ['매치 시작 3시간부터 90분 전까지 참가자 5인 이하인 소셜매치', '무료 취소'],
        ['매치 시작 90분 이내', '환불 불가'],
      ],
    },
    bullets: [
      ...
      '신청 후 30분 이내에는 하루 1회에 한해 무료 취소가 가능합니다. 단, 매치 시작 90분 이내일 경우 불가합니다.',
      '쿠폰 신청자는 매치 시작 90분 전까지 취소 시 쿠폰이 반환됩니다. 2026년 10월 5일부터는 매치 당일 취소 시 사용한 쿠폰이 반환되지 않습니다.',
      '실 결제금액, 쿠폰 제외 기준으로 위 규정에 따라 환불됩니다.',
      '매치 시작 90분 전까지 최소 인원이 모이지 않을 시 카카오톡 혹은 LMS로 안내되며 자동 전액 환불됩니다. 단, 공지 전 직접 취소하는 경우 상단 일반 환불 규정대로 처리됩니다.',
      '90분 내 취소자로 최소 인원이 미달되거나, 구장 시설에 긴급한 문제가 생긴 경우 매치 시작 90분 이내라도 매치를 취소합니다.',
    ],
  },
  {
    question: '안전 유의사항',
    ...
    bullets: [
      '최근 심장/호흡기 질환, 근육·관절 통증이 있다면 매치 참가는 지양해 주세요.',
      '음주, 과로, 임신 중, 고혈압·저혈압 등 신체적 부담이 큰 상태에서는 신청하지 말아 주세요.',
      '매치 중 몸에 이상이 느껴지면 바로 플레이를 멈추고 매니저 또는 주변에 알려주세요.',
  ...
  },
  {
    ...
    bullets: [
      ...
      '2026년 10월 5일부터 슈퍼서브·매니저서브 무료 참가 신청을 매치 당일 취소하면 30일간 무료 참가가 제한됩니다.',
      '참가가 어렵다면 원활한 매치 진행을 위해 일정에서 미리 취소해 주세요.',
    ],
  },
];
